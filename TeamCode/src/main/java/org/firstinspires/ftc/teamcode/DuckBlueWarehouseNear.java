...
@Config
@Autonomous(group = "a")
public class DuckBlueWarehouseNear extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        switch (markerPosition)
        {
            case RIGHT:
                ...
                book.BlueRightWarehouseParkNear(drive.getPoseEstimate());
